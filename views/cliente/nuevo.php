    ...
    <form action="<?= base_url ?>Cliente/create" method="POST" id="registroCliente" novalidate>
      ...
      <div class="form-row p-2">
        ...
        <label for="descuentoCustomer">Id Cliente :</label>
          <input type="text" class="form-control" name="descuentoCustomer" id="descuentoCustomer" value="<?=$id->idTabla;?>" disabled>
          <input type="hidden" name="descuentoCustomer" value="<?=$id->idTabla?>">
          <div class="descuentoCustomer"></div>
        </div>
      </div>
      <div class="smallSubtitle">
      ...
      <div class="form-row p-2">
        ...
        <div class="form-group col-md-6">
        <input type="hidden" class="form-control" name="idDato" id="idDato" value="<?=$domi->idTabla?>">
